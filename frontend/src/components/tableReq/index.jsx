      ...
      const comparator = (a, b) => {
         switch (orderBy) {
            case "TT_INSERT_DATE_FORMATTED":
               return compareDates(a.TT_INSERT_DATE_FORMATTED, b.TT_INSERT_DATE_FORMATTED);
            case "TT_STORE":
            case "TT_TRXNO":
            case "TT_SALES_DATE":
            case "TT_NAMA":
            ...
            case "TT_TOTAL_AMOUNT_PAID":
               return compareCurrency(a.TT_TOTAL_AMOUNT_PAID, b.TT_TOTAL_AMOUNT_PAID);
            default:
               return 0;
         }
      };
                     ...
                     <TableRow>
                        ...
                        <TableCell sx={{ color: "white", textAlign: "center" }}>
                           <TableSortLabel
                              ...
                              direction={
                                 orderBy === "TT_INSERT_DATE_FORMATTED"
                                    ? order
                                    : "asc"
                              }
                              onClick={() =>
                                 handleSort("TT_INSERT_DATE_FORMATTED")
                              }
                           >
                              Request Date
                           </TableSortLabel>
                        ...
                        <TableCell sx={{ color: "white", textAlign: "center" }}>
                           <TableSortLabel
                              ...
                              direction={
                                 orderBy === "TT_SALES_DATE" ? order : "asc"
                              }
                  ...
                  <TableBody>
                     {sortedTransactions()
                        .filter(
                           (trx) =>
                              (statusFilter === "" ||
                                 trx.TT_STATUS === statusFilter) &&
                              trx.TT_TRXNO.toLowerCase().includes(
                                 searchTerm.toLowerCase()
                              )
                        )
                        .slice(page * rowsPerPage, (page + 1) * rowsPerPage) // Menggunakan (page + 1) * rowsPerPage
                        .map((trx, index) => (
                           <TableRow key={trx.TT_TRXNO}>
                              <TableCell>{index + 1}</TableCell>
                              <TableCell>
                                 {trx.TT_INSERT_DATE_FORMATTED}
                              </TableCell>
